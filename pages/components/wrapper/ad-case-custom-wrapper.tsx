...
import GlobalAdCaseWrapper from '../../../components/global/wrapper/GlobalAdCaseWrapper';
import GlobalButtonLinkWrapper from '../../../components/global/wrapper/GlobalButtonLinkWrapper';

const GlobalAdCaseWrapperPage = () => {
 return (
    <DemoTemplateWrapper
      title="Global Ad-Case Wrapper"
      component={
        <>
        <GlobalBillboardWrapper
        heading="Global Ad-Case Wrapper"
     ...
     <GlobalAdCaseWrapper />
          ...
          /> 
 <GlobalButtonLinkWrapper  href="/components/ad-case-custom">
Global Ad-Case - Custom
...
export default GlobalAdCaseWrapperPage;
