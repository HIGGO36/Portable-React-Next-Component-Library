...
import GlobalPaperWrapper from '../../../components/global/wrapper/GlobalPaperWrapper';
import GlobalButtonLinkWrapper from '../../../components/global/wrapper/GlobalButtonLinkWrapper';

const InteractiveContentBoxWrapperPage = () => {
 return (
    <DemoTemplateWrapper
      title="Interactive Content Box  Wrapper"
      component={
        <>
        <GlobalBillboardWrapper
        heading="Interactive Content Box  Wrapper"
          ...
          /> 
 <GlobalButtonLinkWrapper  href="/components/interactive-content-box">
Global Paper "aka" - Interactive Content Box
...
export default InteractiveContentBoxWrapperPage;
