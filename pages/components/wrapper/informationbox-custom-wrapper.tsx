...
import InformationBoxWrapper from '../../../components/compositionModels/InformationWrapper';
import GlobalButtonLinkWrapper from '../../../components/global/wrapper/GlobalButtonLinkWrapper';

const InformationBoxWrapperPage = () => {
 return (
    <DemoTemplateWrapper
      title="Information Box  Wrapper"
      component={
        <>
        <GlobalBillboardWrapper
        heading="Information Box  Wrapper"
      ...
      <InformationBoxWrapper />
          ...
          /> 
 <GlobalButtonLinkWrapper  href="/components/informationbox-custom">
Information Box
...
export default InformationBoxWrapperPage;
